    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id="home">
          ...
          <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6" >
                ...
                <p className="text-[2.5rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor">
                  The Fastest Delivery In <span className="text-orange-600 text-[3rem] lg:text-[5rem]"> Your Town </span>
                </p>
                <p className=" text-base text-textColor text-center md:text-left md:w-[80%]">
                    Don’t worry, our team of ninjas will go out fighting to deliver your package on time, you can rely on us. We deliver goods safely on-time every time 🙏.
                </p>
                <button type="button" 
          ...
          <div className="py-2 flex-1 flex items-center relative" >
                ...
                <div className="w-full h-full absolute top-0 left-0 flex items-center lg:px-32 py-4 gap-4 flex-wrap">
                      {heroData && heroData.map(n =>(
                            ...
                            <p className="text-sm font-semibold text-headingColor"> <span className="text-xs text-black-600">$</span> {n.price}</p>
                      </div>    
                      ))}      
                </div>
          </div>
